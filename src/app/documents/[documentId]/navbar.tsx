...
export const Navbar = () => {
    ...
    const onSaveJSON = () => {
        ...
        onDownload(blob,`document.json`); //TODO : Use Document Name once file is saved to backend;
    };
    ...
    const onSaveHTML = () => {
        ...
        onDownload(blob,`document.html`); //TODO : Use Document Name once file is saved to backend;
    };
    ...
    const onSaveText = () => {
        ...
        onDownload(blob,`document.txt`); //TODO : Use Document Name once file is saved to backend;
    };
